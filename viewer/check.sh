...
#
# Four of the eight spikes are arithmetic and belong here. The other four are
# about what a browser does — do the glyphs *look* right, does the MP4 play in
# Keynote, is a 25-machine fleet legible, does the export serve with no npm —
# and a browser is where they are answered: `./viewer/serve.sh`, then the pages.
#
#   ./viewer/check.sh
#
