 ...
 *
 * <p>dissaly's numbers mean something only if the code stayed inside the simulated
 ...
 * run would be easier to write and would teach that dissaly is a cage.
 */
public class Phase4 {
    ...
    static void attribution() throws Exception {
        ...
        var byJob = Loader.of(Yaml.parse("trust.yaml", """
            ...
            nodes:
              ...
              w0: { instance: m5.large, zone: z, runs: { Worker: dissaly/test/src/Counter.java } }
              w1: { instance: m5.large, zone: z, runs: { dissaly.Job: dissaly/test/src/Peeker.java } }
            """));
