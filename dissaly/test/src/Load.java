...
/**
 * One word count over real gRPC, at a chosen size and a chosen amount of dissaly.
 *
...
public final class Load {
    ...
    public record Result(long programBytes, long rawBytes, long dissalyBytes, long dissalyStops,
