 ...
 *
 * {@code dissaly.api} declares this interface and {@code dissaly.runtime} implements
 * it. The facade has no runtime dependency, so handlers can compile and run unit
 * tests against the API alone.
 *
 * <p>This is an internal API; student code uses {@link Dissaly}.
 */
public interface Bound {
    ...
    /**
     * Charges dissaly's own work to the node ledger and enclosing span. The charge is
