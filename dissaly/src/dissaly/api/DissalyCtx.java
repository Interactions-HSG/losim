...
/**
 * Operations available to a handler through dissaly.
 *
 ...
 * dissaly's allocation and duration are charged to dissaly and excluded from the
 * program's measurements (D13). In {@code reveal("keys", map.size())}, evaluating
 * {@code size()} remains program work; boxing and recording are dissaly work.
 */
public interface DissalyCtx {
     ...
     *
     * <p>Primitive overloads keep boxing inside dissaly's accounting bracket. The
     ...
     * it costs to read is the program's, not dissaly's: a lookup here is a hash
    ...
    /**
     * A channel to another machine, with dissaly on it.
     *
     ...
     *
     * <p>What it is not is a channel of your own. dissaly rides on gRPC's own
