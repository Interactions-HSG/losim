...
final class Agents {
    ...
    private static String body() {
        try (InputStream in = Agents.class.getResourceAsStream("/dissaly/AGENTS.md")) {
        ...
        return "# dissaly, under a gRPC system that already works\n\n"
    ...
    private static String here(Scan scan, Path root) {
        ...
        if (!any) sb.append("Nothing. This project is already the shape dissaly runs.\n");
        return sb.toString();
    }
