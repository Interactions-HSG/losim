...
/**
 * {@code dissaly version} — which dissaly this is, and whether it is the current one.
 *
 * <p>What replaced {@code dissaly update}. A lab used to carry the simulator as
...
public final class Released {
     ...
     *
     * <p>Overridable through {@code DISSALY_DIST}, because the answer to "may
    ...
    public static int main(String[] args) {
        ...
        try {
            ...
            // The only dissaly command that needs the network, so it is the only one
        ...
        System.out.print("""
                %s is released.
                  ...
                  Change dissalyVersion in build.gradle.kts to %s and run ./dissaly.
    ...
    private static Optional<String> latest(String base) throws IOException {
        ...
        if (res.statusCode() == 404) {
            throw new IOException("""
                    ...
                    this deliberately does not ask you for one. Set DISSALY_DIST to a public
    ...
    private static String base(String from) {
        ...
        String env = System.getenv("DISSALY_DIST");
    ...
    private static IOException unreachable(String base, IOException cause) {
        ...
        return new IOException("""
                ...
                This is the only dissaly command that needs the network, and nothing else
                here is affected — your lab builds and runs against the dissaly your build
