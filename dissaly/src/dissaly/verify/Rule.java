...
public enum Rule {
     ...
     *
     * <p>Every duration dissaly knows is reference-machine time divided by
     ...
     * {@code Dissaly.current().sleep(refMs)} is how to write it: reference time, like
     ...
     * <i>dissaly's own pool</i> is platform threads — it is not what goes wrong here.)
     ...
     * a feature (D1); in dissaly, work is spread by <b>calling more machines</b>, and a
     ...
     *
     * <p>dissaly accounts disk through {@code Dissaly.current().wroteDisk(n)} and caps
     ...
     * name and shape are on {@link dissaly.api.Spec}.
     */
     ...
     *
     * <p>dissaly is on both sides of every call as gRPC's own interceptors: that is
