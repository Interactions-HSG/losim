...
/**
 * What dissaly's own work costs, on the thread it costs it on.
 *
 * dissaly runs on the machine's own threads. Opening a span, rendering an
 ...
 * cannot tell dissaly's bytes from the program's, so dissaly has to (D13).
 *
...
public final class Meter {
     ...
     *
     * <p>Paired around a region of dissaly's own work, and deliberately <b>not</b>
     ...
     * back per metered stop, so dissaly pays for its own instrumentation rather
     * than the machine. Without it dissaly bills a machine <i>more</i> the more
