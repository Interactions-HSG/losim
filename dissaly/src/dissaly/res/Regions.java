 ...
 * two things follow from a zone that nothing else in dissaly knows how to work
 ...
 * dissaly for the sake of a table this file happens to carry. A name that is not
...
public final class Regions {
     ...
     * dissaly does not know where {@code rack-3} is.
     */
    ...
    /** What continent a region is on, or "" when dissaly has never heard of it. */
     ...
     * with distance would invite a student to optimise a number dissaly made up.
     */
    public enum Link {
     ...
     * name dissaly cannot place, the answer is {@link Link#CROSS_REGION} — the
