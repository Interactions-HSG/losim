...
/**
 * losim's copy of gRPC's status codes, held against gRPC's own.
 *
 ...
 * server — which is started with {@code losim.jar} alone, so reading
 ...
 * than becoming a simulation losim quietly refuses to load.
 */
class CodesTest {
