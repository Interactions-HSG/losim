...
class JobProtoTest {
    ...
    static void buildLab() throws Exception {
        ...
        // A schema that imports losim's, which is the case worth testing: an
    ...
    @Test
    @DisplayName("and generates no second copy of losim's own classes")
    void generatesNoSecondCopy() throws Exception {
        var log = new StringBuilder();
        assertNotNull(lab.compile(log::append), log.toString());

        // Nothing under gen/losim/pb, and nothing under classes/losim/pb. Both,
