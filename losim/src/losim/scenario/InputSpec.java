 ...
 *
 * <p>What reaches the Job is a {@link losim.pb.Input} carrying these three,
 ...
 * from the seed, and returns a {@link losim.pb.Workload} of its own shape.
 *
 ...
 *               from {@link losim.api.LosimCtx#seed()} instead. Generating is
 ...
 *               {@code Losim.current().units(n)} counts and {@code perUnit:}
