...
public final class JobGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "dissaly.Job";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<dissaly.pb.Input,
      dissaly.pb.Workload> getLoadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Load",
      requestType = dissaly.pb.Input.class,
      responseType = dissaly.pb.Workload.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dissaly.pb.Input,
      dissaly.pb.Workload> getLoadMethod() {
    io.grpc.MethodDescriptor<dissaly.pb.Input, dissaly.pb.Workload> getLoadMethod;
    if ((getLoadMethod = JobGrpc.getLoadMethod) == null) {
      synchronized (JobGrpc.class) {
        if ((getLoadMethod = JobGrpc.getLoadMethod) == null) {
          JobGrpc.getLoadMethod = getLoadMethod =
              io.grpc.MethodDescriptor.<dissaly.pb.Input, dissaly.pb.Workload>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Load"))
              .setSafe(true)
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dissaly.pb.Input.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dissaly.pb.Workload.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<dissaly.pb.Workload,
      dissaly.pb.Result> getRunMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Run",
      requestType = dissaly.pb.Workload.class,
      responseType = dissaly.pb.Result.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dissaly.pb.Workload,
      dissaly.pb.Result> getRunMethod() {
    io.grpc.MethodDescriptor<dissaly.pb.Workload, dissaly.pb.Result> getRunMethod;
    if ((getRunMethod = JobGrpc.getRunMethod) == null) {
      synchronized (JobGrpc.class) {
        if ((getRunMethod = JobGrpc.getRunMethod) == null) {
          JobGrpc.getRunMethod = getRunMethod =
              io.grpc.MethodDescriptor.<dissaly.pb.Workload, dissaly.pb.Result>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dissaly.pb.Workload.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dissaly.pb.Result.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void load(dissaly.pb.Input request,
        io.grpc.stub.StreamObserver<dissaly.pb.Workload> responseObserver) {
     ...
     * </pre>
     */
    default void run(dissaly.pb.Workload request,
        io.grpc.stub.StreamObserver<dissaly.pb.Result> responseObserver) {
  ...
  public static final class JobStub
     ...
     * </pre>
     */
    public void load(dissaly.pb.Input request,
        io.grpc.stub.StreamObserver<dissaly.pb.Workload> responseObserver) {
     ...
     * </pre>
     */
    public void run(dissaly.pb.Workload request,
        io.grpc.stub.StreamObserver<dissaly.pb.Result> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class JobBlockingV2Stub
     ...
     * </pre>
     */
    public dissaly.pb.Workload load(dissaly.pb.Input request) throws io.grpc.StatusException {
     ...
     * </pre>
     */
    public dissaly.pb.Result run(dissaly.pb.Workload request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class JobBlockingStub
     ...
     * </pre>
     */
    public dissaly.pb.Workload load(dissaly.pb.Input request) {
     ...
     * </pre>
     */
    public dissaly.pb.Result run(dissaly.pb.Workload request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getRunMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class JobFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<dissaly.pb.Workload> load(
        dissaly.pb.Input request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<dissaly.pb.Result> run(
        dissaly.pb.Workload request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOAD:
          serviceImpl.load((dissaly.pb.Input) request,
              (io.grpc.stub.StreamObserver<dissaly.pb.Workload>) responseObserver);
          break;
        case METHODID_RUN:
          serviceImpl.run((dissaly.pb.Workload) request,
              (io.grpc.stub.StreamObserver<dissaly.pb.Result>) responseObserver);
          break;
        default:
  ...
  private static abstract class JobBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dissaly.pb.JobOuterClass.getDescriptor();
    }
